...
let AddNameInput = document.getElementsByClassName('add-popup__input_type_name')[0];
let AddLinkInput = document.getElementsByClassName('add-popup__input_type_link')[0];
